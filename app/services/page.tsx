  ...
  return (
    <div className="space-y-28">
      ...
      <section className="max-w-4xl mx-auto">
        ...
        <ol className="mt-12 space-y-10 max-w-2xl mx-auto text-slate-700">
          <li>
      ...
      <section className="max-w-5xl mx-auto">
        ...
        <div className="mt-12 grid gap-10 md:grid-cols-3">
          ...
          <div className="rounded-2xl border p-8 shadow-sm md:col-span-3 hover:shadow-md transition">
      ...
      {/* CTA */}
      <section className="rounded-3xl bg-emerald-600 px-10 py-16 text-center text-white shadow-lg max-w-5xl mx-auto">
