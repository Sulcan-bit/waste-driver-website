...
export function CanadaMap() {
  ...
  return (
    <div
      ref={mapRef}
      className="relative w-full rounded-3xl bg-slate-900 px-4 py-6 text-white shadow-lg"
    >
      ...
      {/* FULL-WIDTH MOBILE MAP + ZOOM + SCROLL */}
      <div className="w-full overflow-auto touch-pan-y touch-pan-x">
