...
{open && (
  <div className="md:hidden border-t bg-white px-6 py-6 space-y-5 text-[15px] font-semibold text-slate-800 shadow-lg">
    ...
    <a href="/services" className="block text-center hover:text-emerald-600 transition-colors">
      Services & Pricing
    </a>

    <a href="/users" className="block text-center hover:text-emerald-600 transition-colors">
      Users
    </a>

    <a href="/drivers" className="block text-center hover:text-emerald-600 transition-colors">
      Drivers
    </a>

    <a href="/technology" className="block text-center hover:text-emerald-600 transition-colors">
      Technology
    </a>

    <a href="/contact" className="block text-center hover:text-emerald-600 transition-colors">
      Contact
    </a>

    <a href="/privacy-policy" className="block text-center hover:text-emerald-600 transition-colors">
      Privacy Policy
    </a>
  ...
  Policy Waiver
    ...
    <a
      href="tel:18339992783"
      className="block text-center font-bold text-slate-900 hover:text-emerald-600 transition-colors"
    >
      1‑833‑99‑WASTE
    </a>
    ...
    <a
      href="/download"
      className="block text-center rounded-lg px-4 py-2 text-[14px] font-semibold 
